...
import 'perio-cam.dart';

class PerioScreen extends StatefulWidget {
  const PerioScreen({super.key});

  @override
  State<PerioScreen> createState() => _PerioScreenState();
}

class _PerioScreenState extends State<PerioScreen> {
                      ...
                      onPressed: () async {
                        try {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  PerioCamScreen(imagePath: image.path),
                            ),
                          );
                        } catch (e) {
                          // Handle error
